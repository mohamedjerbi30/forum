...
export function PlasmaBackground({ 
  ...
  useEffect(() => {
    ...
    const drawPlasma = (time: number, width: number, height: number) => {
      ...
      // Create plasma blobs
      const blobs = [
        { x: 0.2, y: 0.3, size: 0.4, speed: 0.5 },
        { x: 0.7, y: 0.6, size: 0.5, speed: 0.3 },
        { x: 0.5, y: 0.1, size: 0.3, speed: 0.7 },
        { x: 0.1, y: 0.8, size: 0.6, speed: 0.4 },
        { x: 0.9, y: 0.2, size: 0.3, speed: 0.6 }
      ];

      blobs.forEach((blob, i) => {
        const offsetX = Math.sin(time * blob.speed + i * 2) * 100;
        const offsetY = Math.cos(time * blob.speed * 0.7 + i * 1.5) * 80;
        ...
        const alpha = intensity * (0.1 + Math.sin(time + i) * 0.05);
        blobGradient.addColorStop(0, `rgba(40, 56, 77, ${alpha * 0.8})`);
        blobGradient.addColorStop(0.3, `rgba(40, 56, 77, ${alpha * 0.4})`);
        blobGradient.addColorStop(0.7, `rgba(255, 255, 255, ${alpha * 0.2})`);
...
export function PlasmaBackgroundCSS({ 
  ...
  const backgroundStyles = {
    plasma: {
      background: `
        radial-gradient(ellipse at 20% 30%, rgba(40, 56, 77, 0.15) 0%, transparent 50%),
        radial-gradient(ellipse at 70% 60%, rgba(40, 56, 77, 0.1) 0%, transparent 50%),
        radial-gradient(ellipse at 90% 20%, rgba(255, 255, 255, 0.8) 0%, transparent 50%),
        radial-gradient(ellipse at 10% 80%, rgba(40, 56, 77, 0.08) 0%, transparent 50%),
        linear-gradient(135deg, #ffffff 0%, rgba(248, 250, 252, 0.9) 50%, rgba(40, 56, 77, 0.05) 100%)
      `,
    ...
    chromium: {
      background: `
        conic-gradient(from 180deg at 50% 50%, 
          transparent 0deg, 
          rgba(40, 56, 77, 0.03) 45deg, 
          rgba(255, 255, 255, 0.8) 90deg,
          rgba(40, 56, 77, 0.05) 135deg,
          transparent 180deg,
          rgba(40, 56, 77, 0.02) 225deg,
          rgba(255, 255, 255, 0.6) 270deg,
          rgba(40, 56, 77, 0.04) 315deg,
          transparent 360deg
        ),
        linear-gradient(135deg, #ffffff 0%, rgba(248, 250, 252, 0.8) 100%)
      `,
      animation: 'chromiumSpin 12s linear infinite'
    },
    
    fluid: {
      background: `
        radial-gradient(ellipse at 40% 20%, rgba(255, 255, 255, 0.9) 0%, transparent 50%),
        radial-gradient(ellipse at 80% 70%, rgba(40, 56, 77, 0.1) 0%, transparent 50%),
        radial-gradient(ellipse at 10% 90%, rgba(40, 56, 77, 0.08) 0%, transparent 50%),
        linear-gradient(45deg, #ffffff 0%, rgba(248, 250, 252, 0.7) 50%, rgba(40, 56, 77, 0.04) 100%)
      `,
      animation: 'fluidMotion 10s ease-in-out infinite'
    },
    ...
    aurora: {
      background: `
        linear-gradient(45deg, 
          ...
          rgba(40, 56, 77, 0.06) 60%,
          rgba(40, 56, 77, 0.1) 100%
        ),
        radial-gradient(ellipse at 50% 0%, rgba(40, 56, 77, 0.08) 0%, transparent 70%),
