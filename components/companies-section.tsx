        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 max-w-6xl mx-auto">
          {companyLogos.map((logo, index) => (
            ...
            >
              ...
              {/* Coming soon overlay */}
              <div className="absolute inset-0 bg-gradient-to-br from-yellow-500/20 to-cyan-500/20 backdrop-blur-[2px] flex items-center justify-center opacity-100 group-hover:opacity-0 transition-opacity">
